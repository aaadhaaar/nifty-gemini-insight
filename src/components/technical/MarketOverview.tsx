...
const MarketOverview = ({ niftyLevel, resistance, support, overallTrend }: MarketOverviewProps) => {
  return (
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-slate-700/30 rounded-lg p-3">
            ...
            <p className="text-white font-bold text-lg">{niftyLevel}</p>
          </div>
          <div className="bg-slate-700/30 rounded-lg p-3">
          ...
          <div className="bg-slate-700/30 rounded-lg p-3">
            ...
            <p className={`font-bold text-lg capitalize ${overallTrend === 'bullish' ? 'text-green-400' : 'text-red-400'}`}>
              {overallTrend}
            </p>
          </div>
        </div>
